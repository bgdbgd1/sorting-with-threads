...
def process_logs(nr_files, file_size, intervals, pipeline, nr_parallel_threads):
    ...
    log_files = glob.glob(f'logs_determine_bandwidth/logs_threads_test/8_threads_2/*.log')
    ...
    file_path = f'logs_determine_bandwidth/logs_threads_test/8_threads_2/results_nr_files_{nr_files}_file_size_{file_size}_intervals_{intervals}_{pipeline}.json'
